...
open class ElementAdapter(var items: List<Element>, private val onItemClicked: (Element) -> Unit, private val onItemLongClicked: (Element) -> Boolean): RecyclerView.Adapter<ElementViewHolder>() {
